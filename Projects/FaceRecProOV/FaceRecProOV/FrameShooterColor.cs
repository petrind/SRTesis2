...
{
    public partial class FrameShooterColor : Form
    {
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            ImageBoxUpperResult.Image = DisDetector.GetColorPixelMask(currentFrameU, HueMinTB.Value, HueMaxTB.Value, SMinTB.Value, SMaxTB.Value, VMinTB.Value, VMaxTB.Value);
        ...
        private void HMinChanged(object sender, EventArgs e)
        {
            HueMinLabel.Text = "" + HueMinTB.Value;
        }
        private void HMaxChanged(object sender, EventArgs e)
        {
            HueMaxLabel.Text = "" + HueMaxTB.Value;
        }
        private void SMinChanged(object sender, EventArgs e)
        {
            SMinLabel.Text = "" + SMinTB.Value;
        }
        private void SMaxChanged(object sender, EventArgs e)
        {
            SMaxLabel.Text = "" + SMaxTB.Value;
        }
        private void VMinChanged(object sender, EventArgs e)
        {
            VMaxLabel.Text = "" + VMinTB.Value;
        }
        private void VMaxChanged(object sender, EventArgs e)
        {
            VMinLabel.Text = "" + VMaxTB.Value;
        }

...
namespace RedCorona.Net
{
    ...
    public class ClientInfo
    {
        ...
        public static string headLeft = "left",
            ...
            headUp = "up",
            headDown = "down",
            leftElbowYawUp = "leftElbowYawUp",
            leftElbowYawDown = "leftElbowYawDown",
            RShoulderPitchUp = "RShoulderPitchUp",
            RShoulderPitchDown = "RShoulderPitchDown",
            LShoulderPitchUp = "LShoulderPitchUp",
            LShoulderPitchDown = "LShoulderPitchDown",
            RShoulderRollUp = "RShoulderRollUp",
            RShoulderRollDown = "RShoulderRollDown",
            LShoulderRollUp = "LShoulderRollUp",
            LShoulderRollDown = "LShoulderRollDown",
            RElbowYawUp = "RElbowYawUp",
            RElbowYawDown = "RElbowYawDown",
            RElbowRollUp = "RElbowRollUp",
            RElbowRollDown = "RElbowRollDown",
            LElbowRollUp = "LElbowRollUp",
            LElbowRollDown = "LElbowRollDown",
            RWristYawUp = "RWristYawUp",
            RWristYawDown = "RWristYawDown",
            LWristYawUp = "LWristYawUp",
            LWristYawDown = "LWristYawDown";

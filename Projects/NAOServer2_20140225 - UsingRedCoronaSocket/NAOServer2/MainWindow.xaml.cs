...
{ 
    ...
    class SimpleServer
    {
        ...
        {
            server.BroadcastMessage(0x01020304, Encoding.UTF8.GetBytes(text));
        }
        public void BroadcastData(byte[] b)
        {
            server.BroadcastMessage(0x01020304, b);
        }
    }
